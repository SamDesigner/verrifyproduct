        ...
        <div className="flex items-center justify-between px-6 py-3 border-b border-gray-800/80">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="flex items-center gap-2 px-2 py-1 rounded-lg hover:bg-gray-800 transition-colors group">
              ...
              <span className="text-gray-300 text-xs font-medium group-hover:text-white transition-colors hidden md:flex ">
                {displayName}
              </span>
          ...
          {navItems.map(({ id, label, href, icon: Icon, badge, color, activeBg }) => {
            ...
            return (
              <button
                ...
                className={`relative flex items-center gap-2 px-4 py-2 rounded-lg border text-xs font-medium transition-all duration-200 ${isActive
                  ? `${activeBg} ${color}`
