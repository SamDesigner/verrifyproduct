...
export default function VerifyOtpContent({ email }: { email: string }) {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      toastError(error instanceof Error ? error.message : "OTP verification failed");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="flex flex-col gap-10">
      <div>
        ...
        <p className="text-gray-100 text-center">
          ...
          <span className="font-bold text-purple-300">{email || "your email"}</span> <br />
